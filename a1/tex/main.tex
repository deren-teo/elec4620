...
\subsection{\texttt{sidelobes.py}}
\lstinputlisting{../src/sidelobes.py}

\newpage
\subsection{\texttt{multiplying.py}}
\lstinputlisting{../src/multiplying.py}

\newpage
\subsection{\texttt{double\_transform.py}}
\lstinputlisting{../src/double_transform.py}

\newpage
\subsection{\texttt{polezero\_dft.py}}
\lstinputlisting{../src/polezero_dft.py}

\newpage
\subsection{\texttt{interpolation.py}}
\lstinputlisting{../src/interpolation.py}

\subsection{\texttt{sunspots.ipynb}}
\textit{(Starts on the following page)}
\includepdf[pages=-]{pdfpages/q8_sunspots.pdf}

\newpage
\subsection{\texttt{headings.py}}
\lstinputlisting{../src/headings.py}
